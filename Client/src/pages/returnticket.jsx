          ...
          <div className="Pillultrablack smallPad">
            <div className="row justify-content-center">
              <div className="miniform col-5">
                ...
                <h2 className="mt-5 Laptop pt-4 mx-4 text-center">Czy na pewno chcesz zwrócić bilet <br /> nr {sessionStorage.getItem("TicketNumber")}?</h2>
                <div className="mx-5 mt-4 mb-5">
                  <h6 className="ms-4 text-center">Uwaga! Jeśli zwrócisz bilet nie będziesz mógł cofnąć tej operacji, a przelew środków zostanie zlecony na Twoje konto</h6>
                </div>
                <div className="row justify-content-around pt-5 mt-5 mx-5">
                  ...
                  <button className="button col-5 py-3 RedButton" style={{borderRadius: '50px', borderColor: 'red'}} onClick={() => {
                      window.location.href = "/ReturnConfirm"
                    }}>Zwróć bilet</button>
                </div>
              </div>
            </div>
