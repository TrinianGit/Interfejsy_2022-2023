        ...
        <div className="container-fluid">
          <div className="px-5 row align-items-center">
            ...
            <div className="col-6 py-2 px-5 d-flex align-items-center justify-content-between badge rounded-pill Pillwhite">
              <a href="/en/ForgotPassword?#">
                    <div className="flag england">
                    </div>
                </a>
              <div>
                <h2 className="mb-0 fs-2 px-4 float-end"><a href="/Login?#" className="mb-0">Zaloguj się</a></h2>
          ...
          <div className="Pillultrablack smallPad">
            <div className="row justify-content-center">
              <div className="miniform col-5">
                ...
                <h4 className="mb-5 pt-4 mx-4 text-center">Aby odzyskać swoje konto podaj poniżej jego login. Wyślemy na adres e-mail powiązany z kontem wiadomość z linkiem do ustawienia nowego hasła.</h4>
                <form action="#" onSubmit={async() => {
                  ...
                  <div className="row justify-content-around mt-5 mx-5">
                    ...
                    <button className="button col-5 py-3 OrangeButton">Dalej</button>
                  </div>
                </form>
              </div>
            </div>
