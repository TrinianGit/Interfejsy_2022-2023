...
export default function EmailSend() {
  ...
  function myURL() {
      document.location.href = '/EmailLoading';
  }
          ...
          <div className="Pillultrablack smallPad">
            <div className="row justify-content-center">
              <div className="miniform col-5">
                <div className="py-5" />
                <div className="py-2" />
                <h3 className="my-5 pt-5 mx-4 text-center">Wysłaliśmy wiadomość z linkiem na Twój adres e-mail! Znajdziesz w nim dalsze kroki odzyskiwania konta.</h3>
              </div>
            </div>
          </div>
        </div>
