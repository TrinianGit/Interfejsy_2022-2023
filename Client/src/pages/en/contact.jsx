        ...
        <div className="container-fluid">
          <div className="px-5 row align-items-center">
            ...
            <div className="col-6 py-2 px-5 d-flex align-items-center justify-content-between badge rounded-pill Pillwhite">
              <a href="https://centralna-siec-szyn.glitch.me/Contact">
          ...
          <div className="Pillultrablack smallPad">
            <div className="row miniform justify-content-around">
              <div className="col-5 text-center align-self-center">
                <h1>Contact</h1>
                <h4 className="text-start">Contact possible by phone:</h4>
                <h5><a style={{color: 'orange'}} href="tel:+48 675 473 283">675 473 283</a> - for individuals</h5>
                <h5><a style={{color: 'orange'}} href="tel:+48 694 496 444">694 496 444</a> - for carrier companies</h5>
                <h5><a style={{color: 'orange'}} href="tel:+48 213 721 372">213 721 372</a> - business requests</h5>
                <h4 className="text-start">By e-mail:</h4>
                <h5><a style={{color: 'orange'}} href="mailto: klient@css.example.com">klient@css.example.com</a> - for individuals</h5>
                <h5><a style={{color: 'orange'}} href="mailto: kolej@css.example.com">kolej@css.example.com</a> - for carrier companies</h5>
                <h5><a style={{color: 'orange'}} href="mailto: biznes@css.example.com">biznes@css.example.com</a> - business requests</h5>
                <h4 className="text-start">Or by direct visit in our headquarters:</h4>
