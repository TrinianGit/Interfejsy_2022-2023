        ...
        <div className="container-fluid">
          <div className="px-5 row align-items-center">
            ...
            <div className="col-6 py-2 px-5 d-flex align-items-center justify-content-between badge rounded-pill Pillwhite">
              <a href="https://centralna-siec-szyn.glitch.me/UserEdit">
                ...
                <form action="#" onSubmit={() => {
                  ...
                  <div className="row justify-content-between mt-4 mx-3">
                    <div className="text-center col-5">
                      ...
                      <input className="w-50 text-center fs-5 fw-bold Shadow form-control my-4" id="UsName" style={{marginLeft: '25%', borderRadius: '20px'}} type="text" placeholder="First name" onChange={() => {
                          tmpname = document.querySelector("#UsName").value
                        }} required/>
                    </div>
                    <div className="text-center col-5">
                      <h2 className="Laptop">Second Name</h2>
                      <input className="w-50 text-center fs-5 fw-bold Shadow form-control my-4" id="UsName2" style={{marginLeft: '25%', borderRadius: '20px'}} type="text" placeholder="Second name" onChange={() => {
                  ...
                  <div className="row text-center justify-content-center mb-5 mt-4">
                    ...
                    <input className="w-75 text-center fs-5 fw-bold Shadow form-control my-4" id="UsEmail" style={{borderRadius: '20px'}} type="email" placeholder="E-mail address" onChange={() => {
                  ...
                  <div className="row justify-content-center">
                    ...
                    <button className="col-2 my-5 py-3 button OrangeButton">Save changes</button>
                  </div>
                </form>
              </div>
            </div>
