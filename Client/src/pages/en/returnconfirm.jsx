...
export default function ReturnConfirm() {
  ...
  useEffect(async () => {
    sessionStorage.setItem("Prev", "/en/ReturnConfirm")
        ...
        <div className="container-fluid">
          <div className="px-5 row align-items-center">
            ...
            <div className="col-6 py-2 px-5 d-flex align-items-center justify-content-between badge rounded-pill Pillwhite">
              <a href="https://centralna-siec-szyn.glitch.me/ReturnConfirm">
          ...
          <div className="Pillultrablack smallPad">
            <div className="row justify-content-center">
              <div className="miniform col-5">
                ...
                <h2 className="mt-5 pt-4 mx-4 text-center">You've returned ticket no. {sessionStorage.getItem("TicketNumber")}</h2>
                <div className="mx-5 mt-4 mb-5">
                  <h6 className="ms-4 text-center">Because of processing time money could be returned to your account after few hours.</h6>
                </div>
