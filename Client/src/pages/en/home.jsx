...
export default function Home() {
    ...
    useEffect(() => {
        sessionStorage.setItem("Prev", "/en/");
    ...
    const onSubmit2 = async () => {
        ...
        if(sessionStorage.getItem("Compare") === null){
            ...
            window.location.href = '/en/CompareTrains';
        }
    }
    ...
    if (sessionStorage.getItem("Compare") !== null){
        if (sessionStorage.getItem("Compare") === "Price"){
          ...
          if (sessionStorage.getItem("All") === '1'){
            dropdown = "Seats availability (all day)"
          }
          else if (sessionStorage.getItem("All") === '0'){
            dropdown = "Seats availability (+/- 3h)"
          }
        }
        else if (sessionStorage.getItem("Compare") === "TimeTrav"){
          if (sessionStorage.getItem("All") === '1'){
            dropdown = "Travel time (all day)"
          }
          else if (sessionStorage.getItem("All") === '0'){
            dropdown = "Travel time (+/- 3h)"
          }
        }
        else if (sessionStorage.getItem("Compare") === "Changes"){
          if (sessionStorage.getItem("All") === '1'){
            dropdown = "Number of changes (all day)"
          }
          else if (sessionStorage.getItem("All") === '0'){
            dropdown = "Number of changes (+/- 3h)"
          }
        }
    }
    ...
    <div>
        <header className="site-navbar pt-5" role="banner">
            ...
            <div className="px-5 row align-items-center">
                ...
                <a href="https://centralna-siec-szyn.glitch.me/">
        ...
        <div className="container-fluid Laptop px-5">
            ...
            <div className="Pillultrablack">
                ...
                <div className="miniform col-5 my-4">
                    <h2 className="my-4 Title">Search connection!</h2>
                    <Formik onSubmit={onSubmit}>
                    <Form>
                        <div className="row px-5">
                        <input className="form-control my-3" autoComplete="off" value={sessionStorage.getItem('From')} id='From' type="text" placeholder="Origin" onChange={async() => {
                        ...
                        <div className="row px-5">
                        <input className="form-control my-3" autoComplete="off" value={sessionStorage.getItem('To')} id='To' type="text" placeholder="Destination" onChange={async() => {
                        ...
                        <div className="row px-5 justify-content-center align-items-center self-align-center my-3">
                            ...
                            <input className="form-control" id='Time1' type="text" placeholder="Hour" disabled readOnly/>
                            <div className="modal fade" id="timemodal" data-bs-keyboard="false" tabIndex={-1} aria-hidden="true">
                                <div className="modal-dialog modal-dialog-centered">
                                    <div className="modal-content">
                                    <div className="modal-header justify-content-center">
                                        <h1 className="modal-title fs-5 text-black text-center" id="staticBackdropLabel">Pick time</h1>
                                    </div>
                        ...
                        <div className="row px-5">
                            <a className="fs-4 Advanced" href='/en/AdvancedSearch?#'>Advanced Search</a>
                        </div>
                        <div className="row px-2 mx-4 py-2 pt-4">
                            <button className="button OrangeButton" type="submit"><h2 className="py-1">Search</h2></button>
                        </div>
                    </Form>
                    </Formik>
                </div>
                ...
                <div className="miniform col-5">
                    <h2 className="my-4 Title">Compare offers!</h2>
                    <Formik onSubmit={onSubmit2}>

                        <Form>
                        <div className="row px-5">
                        <input className="form-control my-3" autoComplete="off" value={sessionStorage.getItem('From')} id='From2' type="text" placeholder="Origin" onChange={async() => {
                        ...
                        <div className="row px-5">
                            <input className="form-control my-3" autoComplete="off" value={sessionStorage.getItem('To')} id='To2' type="text" placeholder="Destination" onChange={async() => {
                        ...
                        <div className="row px-5 justify-content-center align-items-center self-align-center my-3">
                            ...
                            <input className="form-control" type="text" id='Date2' placeholder="Date" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])-(0[1-9]|1[012])-[0-9]{4}" value={sessionStorage.getItem('Date')} disabled readOnly/>
                            <button className="input-group-text" type='button' data-bs-toggle="modal" data-bs-target="#timemodal">
                                <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-clock" viewBox="0 0 16 16">
                                <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z" />
                                <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z" />
                              ...
                              <input className="form-control" id='Time2' type="text" placeholder="Hour" disabled readOnly/>
                            </div>
                        </div>
                        <div className="row px-5">
                            ...
                            <ul className="dropdown-menu MainPageDropdown">
                                <li><a className="dropdown-item" href="#" onClick={() => {
                                                                                            ...
                                                                                            document.getElementById('Compare').innerHTML = 'Price (+/- 3h)'
                                                                                        }}>Price (+/- 3h)</a></li>
                                <li><a className="dropdown-item" href="#" onClick={() => {
                                                                                            sessionStorage.setItem('Compare', "Price");
                                                                                            sessionStorage.setItem('All', "1");
                                                                                            document.getElementById('Compare').innerHTML = 'Price (all day)'
                                                                                        }}>Price (all day)</a></li>
                                <li><a className="dropdown-item" href="#" onClick={() => {
                                                                                            sessionStorage.setItem('Compare', "Seats");
                                                                                            sessionStorage.setItem('All', "0");
                                                                                            document.getElementById('Compare').innerHTML = 'Seats availability (+/- 3h)'
                                                                                        }}>Seats availability (+/- 3h)</a></li>
                                <li><a className="dropdown-item" href="#" onClick={() => {
                                                                                            sessionStorage.setItem('Compare', "Seats");
                                                                                            sessionStorage.setItem('All', "1");
                                                                                            document.getElementById('Compare').innerHTML = 'Seats availability (all day)'
                                                                                        }}>Seats availability (all day)</a></li>
                                <li><a className="dropdown-item" href="#" onClick={() => {
                                                                                            sessionStorage.setItem('Compare', "TimeTrav");
                                                                                            sessionStorage.setItem('All', "0");
                                                                                            document.getElementById('Compare').innerHTML = 'Travel time (+/- 3h)'
                                                                                        }}>Travel time (+/- 3h)</a></li>
                                <li><a className="dropdown-item" href="#" onClick={() => {
                                                                                            sessionStorage.setItem('Compare', "TimeTrav");
                                                                                            sessionStorage.setItem('All', "1");
                                                                                            document.getElementById('Compare').innerHTML = 'Travel time (all day)'
                                                                                        }}>Travel time (all day)</a></li>
                                <li><a className="dropdown-item" href="#" onClick={() => {
                                                                                            sessionStorage.setItem('Compare', "Changes");
                                                                                            sessionStorage.setItem('All', "0");
                                                                                            document.getElementById('Compare').innerHTML = 'Number of changes (+/- 3h)'
                                                                                        }}>Number of changes (+/- 3h)</a></li>
                                <li><a className="dropdown-item" href="#" onClick={() => {
                                                                                            sessionStorage.setItem('Compare', "Changes");
                                                                                            sessionStorage.setItem('All', "1");
                                                                                            document.getElementById('Compare').innerHTML = 'Number of changes (all day)'
                                                                                        }}>Number of changes (all day)</a></li>
                            </ul>
                            </div>
                        </div>
                        <div className="row px-5 mx-4 py-3 pt-4">
                            <button className="button OrangeButton" type="submit"><h2 className="py-1">Compare</h2></button>
                        </div>
                        </Form>
                    </Formik>
                </div>
