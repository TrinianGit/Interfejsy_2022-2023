...
export default function SearchTrainPl() {
    ...
    if(sessionStorage.getItem("LoggedIn") === '1'){
      logmain = <h2 className="mb-0 fs-2 px-4 float-end"><a href="/en/UserAccount" className="mb-0">Moje konto</a></h2>
    }
    else{
      logmain = <h2 className="mb-0 fs-2 px-4 float-end"><a href="/en/Login?#" className="mb-0">Zaloguj się</a></h2>
    }  
    ...
    useEffect(() => {
      ...
      sessionStorage.setItem("Prev", "/en/SearchResults")
          ...
          <div className="container-fluid">
            <div className="px-5 row align-items-center">
              ...
              <div className="col-6 py-2 px-5 d-flex align-items-center justify-content-between badge rounded-pill Pillwhite">
                <a href="https://centralna-siec-szyn.glitch.me/SearchResults">
            ...
            <div className="Pillultrablack">
              <div className="row text-center align-items-center justify-content-center noyPad py-4">
                <div className="row mb-3">
                  <h2 className="Relation">Trains' relation: {sessionStorage.getItem("From")} - {sessionStorage.getItem("To")}</h2>
                </div>
                <div className="col-1">
                  ...
                  <div className="px-5 mt-4 justify-content-center mb-4">
                    <Formik onSubmit={onSubmit1}>
                      <Form>
                        ...
                        <button className="button OrangeButton ExtraSmallButton px-4 Buy" id="Sub1" type="submit"><h6 className="pt-1 Smalltext" id='Buytext'>Buy ticket</h6></button>
                      </Form>
                    </Formik>
                  </div>
                </div>
                    ...
                    <div className="px-5 mt-4 justify-content-center mb-4">
                      <Formik onSubmit={onSubmit2}>
                        <Form>
                          ...
                          <button className="button OrangeButton ExtraSmallButton px-4 Buy" id="Sub2" type="submit"><h6 className="pt-1 Smalltext" id='Buytext'>Buy ticket</h6></button>
                        </Form>
                      </Formik>
                    </div>
                  </div>
                  ...
                  <div className="px-5 mt-4 justify-content-center mb-4">
                    <Formik onSubmit={onSubmit3}>
                      <Form>
                        ...
                        <button className="button OrangeButton ExtraSmallButton px-4 Buy" id="Sub3" type="submit"><h6 className="pt-1 Smalltext" id='Buytext'>Buy ticket</h6></button>
                      </Form>
                    </Formik>
                  </div>
                </div>
