  ...
  if(sessionStorage.getItem("LoggedIn") === '1'){
    ...
    async function changeTrains(){
      ...
      Object.values(document.querySelectorAll('.Train')).map(y => {
        ...
        if (i == 0){
          y.querySelector(".TextButton").innerHTML = "Najlepsza oferta"
        }
        else {
          y.querySelector(".TextButton").innerHTML = `${i+1} oferta`
        }
    ...
    useEffect(async () => {
      ...
      sessionStorage.setItem("Prev", "/CompareResults")
          ...
          <div className="px-5 py-5">
            <div className="Pillultrablack">
              <div className="row text-center align-items-center justify-content-center noyPad">
                <h2 className="Relation mt-2">Pociągi relacji: {sessionStorage.getItem("From")} - {sessionStorage.getItem("To")}</h2>
                <div className="col-1">
                    ...
                    <div className="px-5 mt-4 justify-content-center mb-4">
                      <Formik onSubmit={onSubmit1}>
                        <Form>
                          ...
                          <button className="button OrangeButton ExtraSmallButton px-4 Buy" type="submit"><h6 className="pt-1 Smalltext" id='Buytext'>Kup bilet</h6></button>
                        </Form>
                      </Formik>
                    </div>
                  </div>
