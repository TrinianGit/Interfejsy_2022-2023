...
import "../styles/badreq.css";


export default function Badreq() {
  
  function myURL() {
      document.location.href = sessionStorage.getItem("Prev");
  }
      ...
      <div className="container">
        <div className="left-section">
          <div className="inner-content">
            <h1 className="heading">400</h1>
            <p className="subheading">Być może to wina naszego serwera, może Twojego błędu we wpisywaniu danych. Tak czy owak, warto spróbować jeszcze raz.</p>
          </div>
        </div>
